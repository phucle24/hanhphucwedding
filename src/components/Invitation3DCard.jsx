      ...
      >
        ...
        >
          ...
          <img 
            ...
            className="absolute top-[-10px] left-[-15px] w-32 pointer-events-none select-none z-10" 
          ...
          <motion.img 
            ...
            className="absolute top-[-15px] right-2 w-14 pointer-events-none select-none z-10 origin-top" 
